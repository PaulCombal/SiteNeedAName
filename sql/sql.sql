...
--
-- Table structure for table `longdesc_suggestions`
--

DROP TABLE IF EXISTS `longdesc_suggestions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `longdesc_suggestions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `desc` varchar(60) COLLATE latin1_general_ci NOT NULL,
  `user_id` int(11) unsigned NOT NULL,
  `file_id` int(11) unsigned NOT NULL,
  `date_last_modified` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_longdesc_suggestions_2_idx` (`user_id`),
  KEY `fk_longdesc_suggestions_1_idx` (`file_id`),
  CONSTRAINT `fk_longdesc_suggestions_1` FOREIGN KEY (`file_id`) REFERENCES `files` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_longdesc_suggestions_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shortdesc_suggestions`
--

DROP TABLE IF EXISTS `shortdesc_suggestions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shortdesc_suggestions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `desc` varchar(60) COLLATE latin1_general_ci NOT NULL,
  `user_id` int(11) unsigned NOT NULL,
  `file_id` int(11) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_shortdesc_suggestions_1_idx` (`user_id`),
  KEY `fk_shortdesc_suggestions_2_idx` (`file_id`),
  CONSTRAINT `fk_shortdesc_suggestions_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_shortdesc_suggestions_2` FOREIGN KEY (`file_id`) REFERENCES `files` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `createNewUser`(IN email_in VARCHAR(45), IN username_in VARCHAR(45), IN passwd_in CHAR(60), IN tempkey_in VARCHAR(120))
BEGIN
	START TRANSACTION;
	INSERT INTO `users` (`email`, `reg_date`, `username`, `password`, `tempkey`) 
    VALUES (email_in, NOW(), username_in, passwd_in, tempkey_in);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getPendingDescriptions` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getPendingDescriptions`(IN file_id_in INT(11))
BEGIN
	(
		SELECT
			*,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getUserByMailOrLogin` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserByMailOrLogin`(IN login_in VARCHAR(45))
BEGIN
	# By default we assume the email is entered.
    # during the registering process, the user must NOT provide an email formatted username.
    # TODO: Find a better registration system?
    
    # Example of what would cause trouble
    
    # USERNAME     | ADDRESS
    # TOTO         | TOTO@LOL.COM
    # TOTO@LOL.COM | TATA@LOL.COM
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insertNewFile` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertNewFile`(
	IN category_id_in INT(11), 
    IN subcategory_in_id INT(11), 
    IN title_in VARCHAR(60), 
    IN shortdesc_in VARCHAR(60), 
    IN longdesc_in TEXT, 
    IN hash_in VARCHAR(100),
    IN httpmirror_in VARCHAR(255),
    IN userid_in INT(11)
    )
BEGIN
	START TRANSACTION;
	...
	INSERT INTO `files` 
    (`category_id`, `subcategory_id`, `title`, `description`, `longdescription`, `uploaddate`, `hash`, `httpmirror`, `user_id`) 
    VALUES
    (category_id_in, subcategory_in_id, title_in, shortdesc_in, longdesc_in, NOW(), hash_in, httpmirror_in, userid_in);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `isAlreadyRegistered` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `isAlreadyRegistered`(IN username_in VARCHAR(45), IN email_in VARCHAR(45))
BEGIN
		SELECT 
			COUNT(*) AS `alreadyRegistered`
		FROM
			users
		WHERE
			email = email_in
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateTempkey` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateTempkey`(IN user_id_in INT(11), IN tempkey_in VARCHAR(120))
BEGIN
	UPDATE `users` 
    SET `tempkey`= tempkey_in
    WHERE `id` = user_id_in;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
