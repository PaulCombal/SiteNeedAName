<div class="dropdown">
	...
	<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
		<li><a href="<?= $base ?>login"><span class="glyphicon glyphicon-log-in"></span> Connexion à mon compte</a></li>
		<li><a href="<?= $base ?>register"><span class="glyphicon glyphicon-user"></span> Créer un compte Monsite</a></li>
