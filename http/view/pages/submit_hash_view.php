...
<html lang="fr">
    ...
    <head>
        ...
        <meta name="description" content="Soumettre un nouveau hash">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <title>Soumettre un fichier | IPFS France</title>

			
		<!-- Main CSS rules -->
		<link rel="stylesheet" href="public/css/bootstrap.min.css" />
		<link rel="stylesheet" href="public/css/custom_submit.css" />
        ...
        <script src="public/js/slidingForm.js"></script>
			    ...
			    <div class="col-md-6 col-md-offset-3">
			        ...
			        <form id="msform" action="./submit" method="POST">
			            ...
			            <fieldset>
			                ...
			                <input type="text" name="http_mirror" placeholder="Mirroir vers un site HTTP (optionnel)" id="opt1" maxlength="255"/>
			            ...
			            <fieldset>
			                ...
			                <br />
			                <a href="javascript:void(0)" id="preview_link" style="display: none;">Preview Markdown</a>
			                <div id="long_desc_preview"></div>
